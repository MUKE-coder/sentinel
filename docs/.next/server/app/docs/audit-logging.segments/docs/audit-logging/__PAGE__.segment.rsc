...
a:["$","h2",null,{"id":"what-gets-logged","children":"What Gets Logged"}]
b:["$","p",null,{"children":"The plugin hooks into GORM callbacks for all mutation operations. Every CREATE, UPDATE, and DELETE that passes through GORM produces an audit entry. Read operations (SELECT) are not audited — they are handled separately by the query shield feature."}]
...
15:["$","h2",null,{"id":"full-example","children":"Full Example"}]
16:["$","p",null,{"children":["The following example shows a complete ",["$","code",null,{"children":"main.go"}]," that sets up Sentinel with the GORM audit logging plugin, creates an HTTP handler that attaches request context, and performs a database mutation that produces an audit trail entry."]}]
2e:Tf98,package main
...
func main() {
    ...
    r.Run(":8080")
}17:["$","$L2",null,{"language":"go","filename":"main.go","code":"$2e"}]
18:["$","h2",null,{"id":"dashboard","children":"Dashboard"}]
19:["$","p",null,{"children":["The Sentinel dashboard includes a dedicated Audit Logs page that provides a searchable, filterable view of your entire audit trail. Access it at"," ",["$","code",null,{"children":"http://localhost:8080/sentinel/ui"}]," and navigate to the Audit Logs section."]}]
1a:["$","ul",null,{"children":[["$","li",null,{"children":[["$","strong",null,{"children":"Search and filter"}]," — filter audit entries by user ID, action type (CREATE, UPDATE, DELETE), resource (table name), and date range."]}],["$","li",null,{"children":[["$","strong",null,{"children":"Before/after diff"}]," — expand any UPDATE entry to see the full before and after JSON state side by side."]}],["$","li",null,{"children":[["$","strong",null,{"children":"User attribution"}]," — each entry shows who performed the action, from which IP, and with which user agent."]}],["$","li",null,{"children":[["$","strong",null,{"children":"Pagination"}]," — large audit trails are paginated for fast browsing."]}]]}]
1b:["$","div",null,{"className":"my-4 rounded-lg border p-4 bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800","children":["$","div",null,{"className":"flex items-start gap-3","children":[["$","svg",null,{"xmlns":"http://www.w3.org/2000/svg","width":18,"height":18,"viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","strokeWidth":2,"strokeLinecap":"round","strokeLinejoin":"round","className":"lucide lucide-info mt-0.5 flex-shrink-0 text-blue-500","children":[["$","circle","1mglay",{"cx":"12","cy":"12","r":"10"}],["$","path","1dtifu",{"d":"M12 16v-4"}],["$","path","e9boi3",{"d":"M12 8h.01"}],"$undefined"]}],["$","div",null,{"children":[["$","p",null,{"className":"font-semibold text-sm mb-1 text-blue-800 dark:text-blue-300","children":"Dashboard Access"}],["$","div",null,{"className":"text-sm text-gray-700 dark:text-gray-300","children":["The audit logs page is part of the Sentinel dashboard UI. It is available automatically when you call ",["$","code",null,{"children":"sentinel.Mount()"}]," — no additional configuration is needed beyond setting up the GORM plugin."]}]]}]]}]}]
1c:["$","h2",null,{"id":"api","children":"API"}]
1d:["$","p",null,{"children":["Audit logs are available via the Sentinel REST API. Use the"," ",["$","code",null,{"children":"GET /sentinel/api/audit-logs"}]," endpoint to query the audit trail programmatically."]}]
1e:["$","h3",null,{"children":"Query Parameters"}]
...
20:["$","h3",null,{"children":"Example Request"}]
21:["$","$L2",null,{"language":"bash","showLineNumbers":false,"code":"curl \"http://localhost:8080/sentinel/api/audit-logs?action=UPDATE&resource=products&page=1&page_size=10\""}]
22:["$","h3",null,{"children":"Example Response"}]
23:["$","$L2",null,{"language":"json","filename":"Response","showLineNumbers":false,"code":"{\n  \"data\": [\n    {\n      \"id\": \"a1b2c3d4-e5f6-7890-abcd-ef1234567890\",\n      \"timestamp\": \"2025-01-15T14:30:00Z\",\n      \"user_id\": \"user-42\",\n      \"user_email\": \"admin@example.com\",\n      \"user_role\": \"admin\",\n      \"action\": \"UPDATE\",\n      \"resource\": \"products\",\n      \"resource_id\": \"7\",\n      \"before\": {\n        \"id\": 7,\n        \"name\": \"Widget\",\n        \"price\": 9.99\n      },\n      \"after\": {\n        \"id\": 7,\n        \"name\": \"Widget Pro\",\n        \"price\": 14.99\n      },\n      \"ip\": \"10.0.0.1\",\n      \"user_agent\": \"Mozilla/5.0 ...\",\n      \"success\": true,\n      \"request_id\": \"req-abc-123\"\n    }\n  ],\n  \"meta\": {\n    \"total\": 1,\n    \"page\": 1,\n    \"page_size\": 10\n  }\n}"}]
24:["$","h2",null,{"id":"testing","children":"Testing"}]
25:["$","p",null,{"children":"You can verify that audit entries are being generated by writing a test that collects events from the pipeline. The pattern below uses an in-memory SQLite database and a custom pipeline handler that captures audit events."}]
2f:Ta43,package main_test
