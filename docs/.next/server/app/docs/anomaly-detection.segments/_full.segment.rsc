...
3f:I[99151,["/_next/static/chunks/4cc5a908347f559b.js","/_next/static/chunks/c23263069b7f7ba3.js","/_next/static/chunks/2425b678dfc0c3cf.js"],"default"]
...
17:["$","$L3f",null,{"language":"go","showLineNumbers":false,"code":"// Enable only specific checks\nChecks: []sentinel.AnomalyCheckType{\n    sentinel.CheckOffHoursAccess,\n    sentinel.CheckImpossibleTravel,\n    // Omit checks that are not relevant to your application\n}"}]
...
21:["$","p",null,{"children":["The ",["$","code",null,{"children":"LearningPeriod"}]," determines the time window for baseline computation. The default is 7 days. A longer period (e.g., 14 or 30 days) produces more stable baselines but adapts more slowly to legitimate changes in user behavior."]}]
...
func main() {
    ...
    r.Run(":8080")
}2c:["$","$L3f",null,{"language":"go","filename":"main.go","code":"$41"}]
...
42:T744,func TestAnomalyDetection(t *testing.T) {
    store := memory.New()
...
}37:["$","$L3f",null,{"language":"go","filename":"anomaly_test.go","code":"$42"}]
